...
static const Cpair cframe = { 0, 9, NORM };
...
static const char *chown_cmd[] = { "chown",
	"-R" };				       /* change file owner and group */
...
//
///* extensions*/
// static const char *images[]    = { "bmp", "jpg", "jpeg", "png", "gif",
// "webp", "xpm" }; static const char *pdf[]       = { "epub", "pdf" }; static
// const char *arts[]      = { "xcf" }; static const char *obj[]       = { "o",
// "a", "so" }; static const char *videos[]    = { "avi", "flv", "wav", "webm",
// "wma", "wmv", 				   "m2v", "m4a", "m4v", "mkv", "mov", "mp3", 				   "mp4", "mpeg", "mpg"
//}; static const char *documents[] = { "odt", "doc", "docx", "xls", "xlsx",
// "odp", 				   "ods", "pptx", "odg" };
//
// static Rule rules[] = {
...
static Key nkeys[] = {
	/* keyval                      function      arg */
	{ 'j', mv_ver, { .i = -1 } }, { XK_DOWN, mv_ver, { .i = -1 } },
	{ 'k', mv_ver, { .i = +1 } }, { XK_UP, mv_ver, { .i = +1 } },
